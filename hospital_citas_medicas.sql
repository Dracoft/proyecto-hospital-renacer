...
CREATE TABLE `citas_medicas` (
  ...
  CONSTRAINT `citas_medicas_ibfk_1` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`cedula`),
  CONSTRAINT `citas_medicas_ibfk_2` FOREIGN KEY (`id_doctor`) REFERENCES `doctores` (`cedula`)
...
INSERT INTO `citas_medicas` VALUES (8,'100087465','2353445','2023-07-10','Medicina general');
...
-- Dump completed on 2023-07-10 21:14:35
